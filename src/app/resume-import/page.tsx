...
export default function ResumeImport() {
  ...
  return (
    <main>
      <div className="mx-auto mt-14 max-w-3xl rounded-md border-2 border-gray-500 px-10 py-10 text-center shadow-md">
        {!hasUsedAppBefore ? (
          <>
    ...
    <>
      ...
      <div className="mt-5">
        <Link href="/resume-builder">
          <Button className="outline-blue-700 bg-primary rounded-lg px-6 pb-2 pt-1.5 text-base font-semibold text-white">
            {" "}
            {buttonText}
          </Button>
        </Link>
